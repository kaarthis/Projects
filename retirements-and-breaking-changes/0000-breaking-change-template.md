...
_Guidance: You should add a Breaking Change notice to any AKS public documentation that uses the feature. The recommended way to do this is to add a file to the "includes" section. See [content contributor guide](https://review.learn.microsoft.com/help/contribute/reusable-content-repo-how-to?branch=main&source=docs) for details._
