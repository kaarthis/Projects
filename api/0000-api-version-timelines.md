...
- **TypeSpec Cutoff** — Deadline is when the TypeSpec changes must be merged into the dev branch.
...
| X month - 3rd week   | Dev branch of TypeSpec is created                                     | Dev could start working on TypeSpec changes |
| X month - 4th week   | RP/TypeSpec cutoff                                                    | Deadline for RP/TypeSpec change             |
| X+1 month - 1st week | TypeSpec release                                                      |                                             |
...
| X month - 3rd week   | Dev branch of TypeSpec is created                                                  | Dev could start working on TypeSpec changes                        |
| X month - 4th week   | RP/TypeSpec cutoff                                                                 | Deadline for RP/TypeSpec change                                    |
| X+1 month - 3rd week | TypeSpec release, bumped SDK and default API version in cli-extensions/aks-preview | Dev could start working on CLI changes, no deadline for CLI change |
